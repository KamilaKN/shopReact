            ...
            <div className={styles.wrapper}>
                <div className={styles["icon-wrapper"]}>
                    ...
                    <img src="/images/grid-view-icon.png" alt="" 
                     onClick={() => props.handleChangeGridView(true)}
                    />
                    <img src="/images/list-view-icon.png" alt="" 
                    onClick={() => props.handleChangeGridView(false)}
                    />
                ...
                <div className={styles.controls}>
                    ...
                    <p>
                        ...
                        <select onChange={e => props.setSorted(e.target.value)} value={props.sorted}>
                            <option value="newest">NewestASC</option>
                            <option value="price">PriceASC</option>
                            <option value="newest">NewestDESC</option>
                            <option value="price">PriceDESC</option>
                        </select>
                    </p>    
                </div>    
            </div>
